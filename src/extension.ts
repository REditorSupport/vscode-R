...
import {
  CancellationToken, commands, CompletionContext, CompletionItem, CompletionItemKind,
  ExtensionContext, Hover, IndentAction, languages, MarkdownString, Position, Range,
  StatusBarAlignment, TextDocument, window
} from 'vscode'

import { previewDataframe, previewEnvironment } from './preview'
import { createGitignore } from './rGitignore'
import {
  chooseTerminal, chooseTerminalAndSendText, createRTerm, deleteTerminal,
  runSelectionInTerm, runTextInTerm
} from './rTerminal'
...
export function activate (context: ExtensionContext): void {
  ...
  async function saveDocument (document: TextDocument): Promise<boolean> {
